...
class BetaFeatureHookHandler implements GetBetaFeaturePreferencesHook {
	...
	public function onGetBetaFeaturePreferences( User $user, array &$prefs ) {
		// Don't offer the opt-in where the carousel is already enabled
		// sitewide; the MediaViewerMobileCarousel flag takes precedence, and a
		// beta toggle for an already-default feature is just confusing.
