...
$messages['zh-hans'] = array(
	'multimediaviewer-desc' => '在浮层中以较大的尺寸显示缩略图。',
	'multimediaviewer-pref' => '媒体文件查看器',
	'multimediaviewer-pref-desc' => '使用这个新工具改善你的多媒体查看体验。它能以更大的尺寸显示页面中的缩略图。图像将显示于一个更漂亮的浮层中，并能以完整尺寸查看。',
	'multimediaviewer-file-page' => '前往对应的文件页面',
	'multimediaviewer-repository' => '在$1了解更多',
	'multimediaviewer-datetime-created' => '创作于$1',
	'multimediaviewer-datetime-uploaded' => '上传于$1',
	'multimediaviewer-userpage-link' => '$1{{GENDER:$2|上传}}',
	...
	'multimediaviewer-discuss-mmv' => '留下反馈',
);
